...
const CourseReviewForm = () => {
  ...
  // Fetch course details (including professors) on mount
  useEffect(() => {
    if (!courseId) return;
  ...
  const handleSubmit = async (e) => {
    ...
    // Map your formData to the course_reviews schema
    const { error } = await supabase.from("course_reviews").insert({
      ...
      class_format: formData.format, // e.g., "In-person", "Online", "Hybrid"
      advice: "", // You can add more info here if needed
    });
